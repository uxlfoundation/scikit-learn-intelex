...
def return_type_constructor(array):
    ...
    if isinstance(array, np.ndarray) or array is None:
        ...
        if hasattr(array, "__array_namespace__"):
            ...
            func = lambda x: (xp.asarray(x) if hasattr(x, "__sycl_usm_array_interface__") else xp.asarray(backend.from_table(x), device=device))
            ...
            func = lambda x: from_usm(xp.asarray(x) if hasattr(x, "__sycl_usm_array_interface__") else xp.asarray(backend.from_table(x), device=device))
