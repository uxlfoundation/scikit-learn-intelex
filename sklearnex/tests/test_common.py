...
_DESIGN_RULE_VIOLATIONS = {
    ...
    "NearestNeighbors-radius_neighbors-n_jobs_check": "radius_neighbors falls back to sklearn",
    "NearestNeighbors-radius_neighbors_graph-n_jobs_check": "radius_neighbors_graph falls back to sklearn",
    "NearestNeighbors(algorithm='brute')-radius_neighbors-n_jobs_check": "radius_neighbors falls back to sklearn",
    "NearestNeighbors(algorithm='brute')-radius_neighbors_graph-n_jobs_check": "radius_neighbors_graph falls back to sklearn",
    ...
    "EmpiricalCovariance-mahalanobis-n_jobs_check": "reuses scikit-learn methods",
    "EmpiricalCovariance-score-call_validate_data": "reuses scikit-learn methods",
}
...
def test_frameworks_lazy_import(monkeypatch):
    ...
    frameworks = test_frameworks.replace("array_api", "array_api_strict")
