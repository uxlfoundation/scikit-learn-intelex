...
_DESIGN_RULE_VIOLATIONS = {
    ...
    "LogisticRegressionCV(solver='newton-cg')-score-n_jobs_check": "uses daal4py for cpu in sklearnex",
    "LogisticRegressionCV(solver='newton-cg')-fit-n_jobs_check": "uses daal4py for cpu in sklearnex",
    "LogisticRegressionCV(solver='newton-cg')-predict-n_jobs_check": "uses daal4py for cpu in sklearnex",
    "LogisticRegressionCV(solver='newton-cg')-predict_log_proba-n_jobs_check": "uses daal4py for cpu in sklearnex",
    "LogisticRegressionCV(solver='newton-cg')-predict_proba-n_jobs_check": "uses daal4py for cpu in sklearnex",
