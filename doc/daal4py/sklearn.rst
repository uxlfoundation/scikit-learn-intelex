...
package, `Extension for Scikit-learn* <https://github.com/uxlfoundation/scikit-learn-intelex>`_.
All future patches will be available only in Extension for Scikit-learn*.
