...
- ``with_preview_mode``: fixture that enables preview mode for the test being executed. Can be useful when part of the estimator's functionality are under preview.
