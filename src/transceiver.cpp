...
// daal4py. It is a pre-existing hook for swapping in an out-of-tree communication
// backend - anything that exports a `transceiver` attribute holding the address of
// a std::shared_ptr<transceiver_iface> - without rebuilding daal4py. Nothing in
// this repository sets it; it is honored here so that such a build keeps working.
