...
req_version["hdbscan_spmd.py"] = (2026, "P", 200)
...
req_device["hdbscan_spmd.py"] = ["gpu"]
req_device["incremental_basic_statistics_dpnp.py"] = ["gpu"]
req_device["incremental_covariance_spmd.py"] = ["gpu"]
req_device["incremental_linear_regression_dpnp.py"] = ["gpu"]
req_device["incremental_pca_dpnp.py"] = ["gpu"]
...
req_library["basic_statistics_spmd.py"] = ["dpctl", "dpnp", "mpi4py"]
...
req_library["hdbscan_spmd.py"] = ["dpctl", "dpnp", "mpi4py"]
